...
struct mensaje *Respuesta::getRequest(void)
{
	...
	if(message_recv.requestId < requestId)
	{
		...
		// NOTIFICAMOS AL CLIENTE QUE YA HABÍA SIDO RECIBIDO EL REGISTRO, PUES ÉSTE ESTARÁ TRATANDO DE REENVIAR
		// EL MENSAJE.
		char mensaje_reconfirmacion[46] = "Registro ya había sido recibido exitosamente.";
		this->sendReply(mensaje_reconfirmacion);
	}
