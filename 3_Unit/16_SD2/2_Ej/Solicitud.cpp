...
char * Solicitud::doOperation(char *ip, int puerto, int operationId, char *arguments, int args_size)
{
	...
	// VARIABLE PARA ALMACENAR LOS ARGUMENTOS RECIBIDOS, EN ESTE CASO UM SIMPLE MENSAJE DE CONFIRMACIÓN, QUE SABEMOS DE ANTEMANO
	// NO SUPERA LOS 32 BYTES
	char *argumentos_respuesta = (char *) malloc(32);
